			...
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:nazzarreen05@gmail.com"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/NzOishie"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/nzoishie/"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
					...
					<p className="text-gray-400 max-w-2xl font-semibold mx-auto italic text-base md:text-md mt-8">
    					It is <b>our choices</b>, that show what we truly are, far more than <b>our abilities.</b>
    					<br />
    					<span className="inline-block align-baseline bg-gradient-to-r from-purple-400 via-blue-400 to-teal-400 bg-clip-text text-transparent  md:text-sm ml-2">
       						 — J.K. Rowling
    					</span>
					</p>
				</motion.div>
